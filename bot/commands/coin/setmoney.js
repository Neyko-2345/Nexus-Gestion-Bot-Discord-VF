...
module.exports = {
    name: "setmoney",
    aliases: ["setcoins"],
    description: "Fixe le solde d'un membre (owner seulement)",
    category: "coin",
    ownerOnly: true,
    usage: ["setmoney <@membre> <montant> [coin|bronze|silver|gold|celestial]"],
